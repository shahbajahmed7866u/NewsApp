...
console.log("cmp")
let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=f9db77eef4174b9b8af7ca428ca9c97f&pageSize=${this.props.pageSize}&page=1`

let data = await fetch(url);
let paredData = await data.json()
console.log(paredData)
this.setState({articles:paredData.articles, totalResults: paredData.totalResults})
}
hanlePrevClick = async () =>{
  console.log("prev")
  let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=f9db77eef4174b9b8af7ca428ca9c97f&pageSize=${this.props.pageSize}&page=${this.state.page-1}`
